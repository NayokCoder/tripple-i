      ...
      <footer className="bg-gray-900 text-white py-16">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {/* Company Info */}
            <div>
              <h3 className="text-xl font-bold mb-4">Triple-I</h3>
              <p className="text-gray-400 mb-6">Empowering businesses with innovative IT solutions and cutting-edge technology services.</p>
            ...
            <div>
              ...
              <div className="flex">
                <input type="email" placeholder="Your email" className="flex-1 px-4 py-2 bg-gray-800 border border-gray-700 rounded-l-lg focus:outline-none focus:border-blue-500" />
          ...
          <div className="border-t border-gray-800 mt-12 pt-8 text-center">
            <p className="text-gray-400">© 2024 Triple-I. All rights reserved. | Privacy Policy | Terms of Service</p>
          </div>
        </div>
      </footer>
      ;
